...
## سلوك البوت مع المستخدمين المحظورين

### الحظر الصامت (Silent Blocking)
عندما يكون المستخدم محظوراً من استخدام الردود الآلية أو الذكاء الاصطناعي:
- **لا يتم إرسال أي رد للمستخدم**
- **البوت يتجاهل الرسالة بشكل كامل**
- **لا تظهر رسالة خطأ للمستخدم المحظور**

هذا السلوك يوفر:
- عدم إزعاج المستخدمين المحظورين برسائل خطأ
- الحفاظ على الخصوصية (المستخدم لا يعرف أنه محظور)
- تجربة استخدام أنظف
